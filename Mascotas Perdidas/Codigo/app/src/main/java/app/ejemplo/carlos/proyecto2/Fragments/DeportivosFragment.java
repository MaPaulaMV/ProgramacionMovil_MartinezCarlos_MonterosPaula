 ...
 * {@link DeportivosFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DeportivosFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DeportivosFragment extends Fragment {
    ...
    public DeportivosFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static DeportivosFragment newInstance(String param1, String param2) {
        DeportivosFragment fragment = new DeportivosFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_deportivos,container,false);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (final DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    if(objeto.getTipo().toString().equals("Herid@")){
                        list.add(objeto);
                    }
